...
// Async Storage
export const STORE_ID = '@NativeApp';
...
export const URL_INSTAGRAM = 'https://www.instagram.com/mieuxquedesfleurs';
export const URL_WEBSITE = 'https://mieuxquedesfleurs.com/';
